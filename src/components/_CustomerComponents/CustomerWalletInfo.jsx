...
import { Eye, Search, XCircle, ArrowUpRight, ArrowDownRight, Wallet, Truck, Gift } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-lg font-semibold">Transactions ({transactionsData?.length})</h2>
        ...
        <div className="relative mb-6">
          <input
            type="text"
            placeholder="Search transactions by reference or type"
            className="w-full pl-10 pr-4 py-2 border rounded-lg focus:ring-0"
          />
