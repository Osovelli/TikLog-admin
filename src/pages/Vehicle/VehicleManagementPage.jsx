...
const TabButton = ({ label, active, onClick }) => (
  <button
    onClick={onClick}
    className={`md:px-4 flex-1 md:flex-none px-2 py-2 text-sm font-medium rounded-lg ${
      active 
        ? 'bg-white shadow' 
  ...
  return (
    ...
    <div className="p-6 space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="flex gap-2 p-1 w-full bg-gray-100 rounded-lg mt-4 md:mt-0">
          <TabButton
            label="Vehicle List"
        ...
        <Button className="bg-indigo-600 hover:bg-indigo-700 p-1 w-full md:w-auto text-white rounded-lg flex items-center justify-center mt-4 md:mt-0"
